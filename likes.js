...
console.log(likes(['Anvar','Gaus','Maksim','Slamir','Arsen','Bekzat']));

// let names = ['Anvar','Gaus','Maksim','Slamir','Arsen','Bekzat']
...
// } else if (names.length > 3) {
//   console.log(`${names[0]}, ${names[1]} and ${names.length - 2} other like this`);
// }